...
function Container({ children, height, leftLine = false, style }) {
  return (
    <div
      style={{ height }}
      className={`w-[720px] bg-[#363C43]  grid grid-cols-[2rem_1fr_2rem] p-2 gap-4 rounded-[18.89px] shadow-[5.67px_5.67px_3.78px_0px_rgba(0,0,0,0.4)] ${style}`}
    >
      {/* question and boxed */}
      {leftLine && (
